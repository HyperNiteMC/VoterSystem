...
public class VoteStatsManager {
    private static VoteStatsManager vcounter;
    private HashMap<UUID, VoteStats> stats = new HashMap<>();

    public static VoteStatsManager getInstance() {
        if (vcounter == null) vcounter = new VoteStatsManager();
        return vcounter;
    }
    ...
    public void setVotes(UUID player, int amount) {
        ...
        VoterUtils.runAsync(()->RedisCommitManager.getInstance().commitStats(player, stats.get(player)));
    }
    ...
    public void removeVotedToday(UUID player) {
        ...
        VoterUtils.runAsync(()->RedisCommitManager.getInstance().commitVotedToday(player, false));
    }
